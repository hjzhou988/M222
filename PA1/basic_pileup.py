...
def consensus(ref, reads):
    ...
    for i in range(len(ref)):
        ...
        ref_base = ref[i]
        base_count[ref_base] += 2.1  # If we only have a single read covering a region, we favor the reference.
        ...
        #if base_count[consensus_base]<5: # if the consensus_base don't appear enough times in the reads, still usereference base.
